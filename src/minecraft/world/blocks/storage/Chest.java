package minecraft.world.blocks.storage;
...
public class Chest extends StorageBlock {
    ...
    public static void playerSpawn(Tile tile, Player player) {
        if (player == null || tile == null || !(tile.build instanceof CoreBlock.CoreBuild entity)) return;
    ...
    public void setBars() {
        ...
        addBar("capacity", (CoreBlock.CoreBuild e) -> new Bar(
