...
public abstract class PlanetGen extends BasicGenerator implements HexMesher{
    ...
    public void addWeather(Sector sector, Rules rules){
        ...
        boolean hasRain = floors.length > 0 && !hasSnow && content.contains(MinecraftLiquids.water_still) && !floors[0].name.contains("sand");
        boolean hasDesert = floors.length > 0 && !hasSnow && !hasRain && floors[0] == MinecraftBlocks.sand;
